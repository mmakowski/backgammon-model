...
unitTests = testGroup "Backgammon.Format unit tests"
  ...
  , testCase "pieces on the bar are parsed correctly" $
      parseBoard "b1|b1....w5|.w3...b5|w5...b3.|b5.....|w2" @?= 
      (Right (Board [ Just (Black, 1), Nothing, Nothing, Nothing, Nothing, Just (White, 5), Nothing, Just (White, 3), Nothing, Nothing, Nothing, Just (Black, 5)
